        ...
        <Container>
          ...
          <form>
            <ul>
              ...
              {questions
                .slice(questionsShow - 5, questionsShow)
                .map((questions) => {
                  return (
                    <li key={questions.id}>
                      ...
                      <div className="radio-group">
                        <input
                          type="radio"
                          id="option-one"
                          name={`selector${questions.id}`}
                        />
                        <label
                          htmlFor="option-one"
                          onClick={() =>
                            handleSelectedAnswer(questions.questionNumber, 1)
                          }
                          className={
                            selectedQuestions[questions.questionNumber - 1] ===
                            1
                              ? 'selected'
                              : ''
                          }
                        ...
                        <label
                          htmlFor="option-two"
                          onClick={() =>
                            handleSelectedAnswer(questions.questionNumber, 2)
                          }
                          className={
                            selectedQuestions[questions.questionNumber - 1] ===
                            2
                        ...
                        <label
                          ...
                          onClick={() =>
                            handleSelectedAnswer(questions.questionNumber, 3)
                          }
                          className={
                            selectedQuestions[questions.questionNumber - 1] ===
                            3
                        ...
                        <label
                          htmlFor="option-four"
                          onClick={() =>
                            handleSelectedAnswer(questions.questionNumber, 4)
                          }
                          className={
                            selectedQuestions[questions.questionNumber - 1] ===
                            4
                        ...
                        <label
                          htmlFor="option-five"
                          onClick={() =>
                            handleSelectedAnswer(questions.questionNumber, 5)
                          }
                          className={
                            selectedQuestions[questions.questionNumber - 1] ===
                            5
          ...
          <section>
            ...
            <ContainerButton display={5 + 1 < questionsShow ? 'flex' : 'none'}>
              <ButtonDefault onClick={handleBackButton}>Voltar</ButtonDefault>
            </ContainerButton>

            <ContainerButton
              display={numberQuestions - 1 < questionsShow ? 'none' : 'flex'}
            >
